...
const Createpage = () => {
  ...
  const config = {
    ...
    // Make the editor itself transparent; wrapper will provide the glass look
  ...
  `}</style>
      ...
      {/* CREATE YOUR BLOG (now glassy/transparent & NOT nested) */}
        ...
        <div className="max-w-5xl mx-auto rounded-2xl bg-black/1 backdrop-blur-md border border-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
          ...
          <div className="px-6 sm:px-8 md:px-12 pb-10">
            <form onSubmit={handleSubmit}>
              ...
              {/* Editor wrapper gets the glass background; editor itself is transparent */}
              ...
              <div className="w-full flex justify-center mt-8">
                ...
                >
                  {isSummarizing ? "Publishing..." : "Publish"}
                </button>
              </div>
            </form>
          </div>
